...
public class MedicoDetalhe extends AppCompatActivity {
    ...
    private void deletarMedico(){
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(MedicoDetalhe.this);
    ...
    private void editar(){
        ...
        Intent intent = new Intent(MedicoDetalhe.this, MedicoCadastro.class);
