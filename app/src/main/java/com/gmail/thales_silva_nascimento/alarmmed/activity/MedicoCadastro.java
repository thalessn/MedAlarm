...
public class MedicoCadastro extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ContextCompat.checkSelfPermission(MedicoCadastro.this, Manifest.permission.READ_CONTACTS)
                        != PackageManager.PERMISSION_GRANTED){

                    //Manda uma requisição de permissão
                    //Isto irá mostrar o diálogo padrão de permissão.
                    ActivityCompat.requestPermissions(MedicoCadastro.this, new String[]{Manifest.permission.READ_CONTACTS},
        ...
        if (intent != null) {
            ...
            if (tipoTela == 1) {
                ...
                toolbar.setNavigationOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        AlertDialog.Builder alertDialog = new AlertDialog.Builder(MedicoCadastro.this);
                        ...
                        alertDialog.setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(MedicoCadastro.this, "Cancelou", Toast.LENGTH_LONG).show();
                            }
                        });
