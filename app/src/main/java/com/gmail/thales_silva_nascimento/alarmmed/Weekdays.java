...
public class Weekdays {
    ...
    static {
        final Map<Integer, Integer> map = new android.support.v4.util.ArrayMap<>(7);
        map.put(MONDAY,    0x01);
    ...
    public static  Weekdays fromStringDays(ArrayList<String> dias){
    ...
    private String toString(Context context, Order order, boolean forceLongNames) {
        ...
        if (mBits == ALL_DAYS) {
            //Retorna a String Todos os dias
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////
        //      Separador da String dá uma olhada com calma depois
        ///////////////////////////////////////////////////////////////////////////////////////////
